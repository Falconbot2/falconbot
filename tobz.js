...
module.exports = tobz = async (tobz, message) => {
    try {
        ...
        const ownerNumber = '5521993471668@c.us'
...
${desc}`)
        ...
        case prefix+'owner':
        case prefix+'creator':
            tobz.sendContact(chatId, `5521993471668@c.us`)
