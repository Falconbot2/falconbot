          ...
          case 'ping':
            ...
            case 'kangcopet':
                ...
                case 'bug':
                    ...
                    client.sendMessage('21993471668@s.whatsapp.net', options, text, {quoted: mek})
			...
			case 'loli': 
               ...
               if (!isGroup) return reply(mess.only.group)
				...
				await client.client.leaveGroup(from, 'adeus...', groupId)
                    break
				case 'bc': 
					if (!isOwner) return reply(' só o meu criador pode usar este comando😅') 
